...
## Hidden Critical
1. #2492 - Rollover not works appropriotely with CronTriggeringPolicy and SizeBasedTriggeringPolicy (Author: minkyu97)
2. #3875 - Create dependency injection metadata index (Author: jvz [Member])
