...
- Hidden Critical Count: 0
- Duplicate Clusters Count: 0
- Stale PRs Count: 26
...
3. #3468 - Modernise `RollingRandomAppenderDirectWriteAndSwitchDirectoryTest` (Author: ppkarwasz [Member], 477 days inactive)
...
6. #3588 - Update pattern logger precision  example and description (Author: cretzbach, 430 days inactive)
7. #3657 - Add Max Base as collaborator (Author: ppkarwasz [Member], 389 days inactive)
8. #3658 - fix toString() method in configuration implementations (apache#3599) (Author: anindita-sarkarArray, 357 days inactive)
...
12. #3869 - Synchronize Log4jLogEvent-related changes from 2.x (Author: jvz [Member], 229 days inactive)
13. #3877 - Simplify name and alias annotation processing (Author: jvz [Member], 229 days inactive)
