...
## Hidden Critical
1. #2073 - NPE in ConfigurationScheduler for a frequently executing cron schedule (Author: ghost)
2. #2229 - Test MongoDB appender against Docker image (Author: ppkarwasz [Member])
3. #2492 - Rollover not works appropriotely with CronTriggeringPolicy and SizeBasedTriggeringPolicy (Author: minkyu97)
4. #3251 - Generate `Log4jPlugins` class does not compile in JPMS (Author: ppkarwasz [Member])
5. #3648 - lost log files under high load (using .gz) (Author: dasvex)
